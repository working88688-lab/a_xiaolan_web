...
;(function () {
  ...
  var w = /:[0-9]+$/,
    y = function (a, b) {
      ...
      'port' === b
        ...
        : 'host' === b && (a.hostname = (a.hostname || r.location.hostname).replace(w, '').toLowerCase())
      var c = x(a.protocol)
      b && (b = String(b).toLowerCase())
      switch (b) {
  ...
  var Q = function (a, b, c) {
      ...
      r.history &&
        ...
        (M.test(b) || M.test(c)) &&
        ((a = y(a, 'path')), (b = d(b, '?')), (c = d(c, '#')), r.history.replaceState({}, void 0, '' + a + b + c))
    },
    P = function (a) {
      var b = void 0 === b ? 3 : b
      try {
...
;(function () {
  ...
  var ad = void 0,
    bd = function (a) {
      return ad
        ? ad
        : (a ? 'https:' : Ba || 'https:' == M.location.protocol ? 'https:' : 'http:') + '//www.google-analytics.com'
    },
    Da = function (a) {
      this.name = 'len'
      this.message = a + '-8192'
  ...
  pc.prototype.send = function (a) {
    if (!(1 > arguments.length)) {
      ...
      b &&
        ((c = za(qc[b] || [], c)), (c[Va] = b), this.b.set(c, void 0, !0), this.filters.D(this.b), (this.b.data.m = {}))
    }
  }
  ...
  var u = function (a, b, c) {
    ...
    y = function (a, b, c, d, e) {
      if (!ea(Yd.get(b)) && !$d.get(b)) {
        ...
        if (
          c &&
          ((c && 0 <= c.indexOf('/')) || (c = (ad ? ad + '/34' : bd(!1) + '/plugins/ua/') + c),
          (d = ae(c)),
          (a = d.protocol),
            ...
            (a = (a = (M.querySelector && M.querySelector('script[nonce]')) || null)
              ...
              e
                ? ((e = ''),
                  ...
                  f.test(d) && M.write('<script' + e + ' src="' + d + '">\x3c/script>'))
