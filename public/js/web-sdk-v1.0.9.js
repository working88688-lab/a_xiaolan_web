!(function (e, t) {
  'object' == typeof exports && 'undefined' != typeof module
    ...
    : 'function' == typeof define && define.amd
      ? define(['exports'], t)
      : t(((e = 'undefined' != typeof globalThis ? globalThis : e || self).WebSDK = {}))
})(this, function (e) {
  'use strict'
  ...
  class s {
    ...
    async pickFastestEndpoint(e, t) {
      if ('undefined' == typeof fetch) {
        ...
        return (
          t &&
            ...
            console.warn &&
            console.warn('[sdk][probe] fetch unavailable, fallback to first endpoint:', t),
          t
        )
      }
      const i = e.map(async e => {
          ...
          try {
            return (
              await this.withTimeout(fetch(i, { method: 'GET', mode: 'no-cors', cache: 'no-store' }), t),
      ...
      return n.length
        ? (n.sort((e, t) => e.cost - t.cost),
          'undefined' != typeof console &&
            console.log &&
            console.log('[sdk][probe] selected fastest endpoint:', n[0].endpoint, `${n[0].cost}ms`),
          n[0].endpoint)
        : ''
    }
    notifyEndpointReady() {
    ...
    setSelectedBatchEndpoint(e) {
      const t = String(e || '')
      t && t !== this.selectedBatchEndpoint && ((this.selectedBatchEndpoint = t), this.notifyEndpointReady())
    }
    startRemoteProbe(e) {
      const t = e.join('|')
      return e.length
        ? ((this.remoteProbePromise && this.remoteProbeKey === t) ||
            ...
            (this.shouldPersistQueueOnProbeFailure = !1),
            (this.remoteProbePromise = this.pickFastestEndpoint(e, this.timeoutMs)
              .then(t => {
                if (t) this.setSelectedBatchEndpoint(t)
                  ...
                  ;(this.setSelectedBatchEndpoint(i),
                    'undefined' != typeof console &&
                      console.log &&
                      console.log('[sdk][probe] all failed, random endpoint selected:', i))
                }
    ...
    async refreshDomainConfig(e) {
      ...
      return (
        ...
        'undefined' != typeof console && console.log && console.log('[sdk][config] resolved batch endpoint list:', i),
        i.length
          ? ((this.hasBatchProbeStarted = !0), this.startRemoteProbe(i), this.selectedBatchEndpoint)
          : this.selectedBatchEndpoint
      )
    }
    async init(e) {
        ...
        return (
          this.initPromise ||
            (this.initPromise = (async () => {
              ;((this.initialized = !0), this.refreshDomainConfig(e).catch(() => {}))
            })()),
          this.initPromise
        )
    }
    async resolveEndpoint(e, t) {
      return t || (await this.init(e), this.selectedBatchEndpoint ? this.selectedBatchEndpoint : '')
    }
    onEndpointReady(e) {
    ...
    consumeProbeFailurePersistSignal() {
      return !!this.shouldPersistQueueOnProbeFailure && ((this.shouldPersistQueueOnProbeFailure = !1), !0)
    }
    getEndpointState() {
      return this.selectedBatchEndpoint ? 'ready' : this.remoteEndpoints.length > 0 ? 'probing' : 'unavailable'
    }
                ...
                var i = function () {
                  ...
                  c = (o.WordArray = s.extend({
                    ...
                    concat: function (e) {
                      ...
                      else for (var s = 0; n > s; s += 4) t[(r + s) >>> 2] = i[s >>> 2]
                  ...
                  l = (d.Hex = {
                    stringify: function (e) {
                      for (var t = e.words, i = e.sigBytes, r = [], n = 0; i > n; n++) {
                  ...
                  p = (o.BufferedBlockAlgorithm = s.extend({
                    ...
                    _process: function (t) {
                      var i,
                        ...
                        l = e.min(4 * d, o)
                      if (d) {
                        for (var u = 0; d > u; u += s) this._doProcessBlock(n, u)
                  ...
                  (s = t.algo.SHA1 =
                    (n = i.Hasher).extend({
                      ...
                      _doProcessBlock: function (e, t) {
                        for (
                          var i = this._hash.words, r = i[0], n = i[1], s = i[2], a = i[3], c = i[4], d = 0;
                          80 > d;
                          d++
                        ) {
                          if (16 > d) o[d] = 0 | e[t + d]
              ...
              (r = i.Base).extend({
                ...
                compute: function (e, t) {
                  for (
                    ...
                    ;(i && o.update(i), (i = o.update(e).finalize(t)), o.reset())
                    for (var l = 1; d > l; l++) ((i = o.finalize(i)), o.reset())
                    s.concat(i)
                  }
                    ...
                    return (
                      (e.Encryptor = e.extend({
                        processBlock: function (e, i) {
                          var r = this._cipher,
                            n = r.blockSize
                          ;(t.call(this, e, i, n), r.encryptBlock(e, i), (this._prevBlock = e.slice(i, i + n)))
                        }
                      })),
                      (e.Decryptor = e.extend({
                        processBlock: function (e, i) {
                          var r = this._cipher,
                            n = r.blockSize,
                            o = e.slice(i, i + n)
                          ;(r.decryptBlock(e, i), t.call(this, e, i, n), (this._prevBlock = o))
                        }
                      })),
                      e
                    )
                  ...
                  reset: function () {
                    ...
                    ;(this._xformMode == this._ENC_XFORM_MODE
                      ...
                      this._mode && this._mode.__creator == e
                        ...
                        : ((this._mode = e.call(r, this, i && i.words)), (this._mode.__creator = e)))
                  },
                  _doProcessBlock: function (e, t) {
                ...
                var p = (i.CipherParams = r.extend({
                  ...
                  y = ((e.format = {}).OpenSSL = {
                    stringify: function (e) {
                      var t = e.ciphertext,
                        i = e.salt
                      return (i ? n.create([1398893684, 1701076831]).concat(i).concat(t) : t).toString(s)
                    },
                    parse: function (e) {
                      var t,
                        i = s.parse(e),
                      ...
                      return (
                        1398893684 == r[0] &&
                          1701076831 == r[1] &&
                          ((t = n.create(r.slice(2, 4))), r.splice(0, 4), (i.sigBytes -= 16)),
                  ...
                  g = ((e.kdf = {}).OpenSSL = {
                    execute: function (e, t, i, r, o) {
                      if ((r || (r = n.random(8)), o)) s = a.create({ keySize: t + i, hasher: o }).compute(e, r)
                      else var s = a.create({ keySize: t + i }).compute(e, r)
                      var c = n.create(s.words.slice(t), 4 * i)
                      return ((s.sigBytes = 4 * t), p.create({ key: s, iv: c, salt: r }))
                    }
                  }),
                  m = (i.PasswordBasedCipher = f.extend({
                    cfg: f.cfg.extend({ kdf: g }),
                    encrypt: function (e, t, i, r) {
                      var n = (r = this.cfg.extend(r)).kdf.execute(i, e.keySize, e.ivSize, r.salt, r.hasher)
                      r.iv = n.iv
                    ...
                    decrypt: function (e, t, i, r) {
                      ...
                      return ((r.iv = n.iv), f.decrypt.call(this, e, t, n.key, r))
                    }
                  }))
              })()
            ))
                ...
                e.exports =
                  ...
                  (function (e) {
                    var i = t,
                      ...
                      a = []
                    !(function () {
                      for (var t = 0; 64 > t; t++) a[t] = (4294967296 * e.abs(e.sin(t + 1))) | 0
                    })()
                    var c = (s.MD5 = o.extend({
                      ...
                      _doProcessBlock: function (e, t) {
                        ...
                        ;((x = d(x, B, P, A, s, 7, a[0])),
                          ...
                          (x = l(x, (B = d(B, P, A, x, C, 22, a[15])), P, A, c, 5, a[16])),
                          ...
                          (x = u(x, (B = l(B, P, A, x, k, 20, a[31])), P, A, g, 4, a[32])),
                          ...
                          (x = h(x, (B = u(B, P, A, x, p, 23, a[47])), P, A, s, 6, a[48])),
                      ...
                      _doFinalize: function () {
                        ...
                        ;((i[15 + (((n + 64) >>> 9) << 4)] =
                          ...
                          this._process())
                        for (var a = this._hash, c = a.words, d = 0; 4 > d; d++) {
                          var l = c[d]
                    ...
                    ;((i.MD5 = o._createHelper(c)), (i.HmacMD5 = o._createHmacHelper(c)))
                  })(Math),
                  t.MD5)
              })(m)),
            E(),
              ...
              !(function () {
                ...
                for (t = 0; 256 > t; t++) {
                  ...
                  var f,
                    ...
                    m = e[g],
                    _ = e[m]
                  ;((s[i] = ((f = (257 * e[y]) ^ (16843008 * y)) << 24) | (f >>> 8)),
                    (a[i] = (f << 16) | (f >>> 16)),
                    (c[i] = (f << 8) | (f >>> 24)),
                    (d[i] = f),
                    (l[y] = ((f = (16843009 * _) ^ (65537 * m) ^ (257 * g) ^ (16843008 * i)) << 24) | (f >>> 8)),
                    (u[y] = (f << 16) | (f >>> 16)),
                    (h[y] = (f << 8) | (f >>> 24)),
                    (p[y] = f),
                    i ? ((i = g ^ e[e[e[_ ^ g]]]), (r ^= e[e[r]])) : (i = r = 1))
                }
              })()
              var y = [0, 1, 2, 4, 8, 16, 32, 64, 128, 27, 54],
                f = (r.AES = i.extend({
                          ...
                          : ((d = o[s - 1]),
                            s % i
                              ...
                              : ((d =
                                ...
                                (d ^= y[(s / i) | 0] << 24)),
                            (o[s] = o[s - i] ^ d))
                      for (var a = (this._invKeySchedule = []), c = 0; r > c; c++) {
                        if (((s = r - c), c % 4)) var d = o[s]
                        else d = o[s - 4]
                        a[c] =
                          4 > c || 4 >= s
                            ? d
                            : l[n[d >>> 24]] ^ u[n[(d >>> 16) & 255]] ^ h[n[(d >>> 8) & 255]] ^ p[n[255 & d]]
                      }
                    }
                  },
                  ...
                  decryptBlock: function (e, t) {
                    ...
                    ;((e[t + 1] = e[t + 3]),
                      (e[t + 3] = i),
                      this._doCryptBlock(e, t, this._invKeySchedule, l, u, h, p, o),
                      (i = e[t + 1]),
                      (e[t + 1] = e[t + 3]),
                      (e[t + 3] = i))
                  },
                  _doCryptBlock: function (e, t, i, r, n, o, s, a) {
                    for (
                      ...
                      var f = r[d >>> 24] ^ n[(l >>> 16) & 255] ^ o[(u >>> 8) & 255] ^ s[255 & h] ^ i[p++],
                        g = r[l >>> 24] ^ n[(u >>> 16) & 255] ^ o[(h >>> 8) & 255] ^ s[255 & d] ^ i[p++],
                        m = r[u >>> 24] ^ n[(h >>> 16) & 255] ^ o[(d >>> 8) & 255] ^ s[255 & l] ^ i[p++],
                        _ = r[h >>> 24] ^ n[(d >>> 16) & 255] ^ o[(l >>> 8) & 255] ^ s[255 & u] ^ i[p++]
                      ;((d = f), (l = g), (u = m), (h = _))
                    }
                    ;((f =
                      ((a[d >>> 24] << 24) | (a[(l >>> 16) & 255] << 16) | (a[(u >>> 8) & 255] << 8) | a[255 & h]) ^
                      i[p++]),
                      (g =
                        ((a[l >>> 24] << 24) | (a[(u >>> 16) & 255] << 16) | (a[(h >>> 8) & 255] << 8) | a[255 & d]) ^
                        i[p++]),
                      (m =
                        ((a[u >>> 24] << 24) | (a[(h >>> 16) & 255] << 16) | (a[(d >>> 8) & 255] << 8) | a[255 & l]) ^
                        i[p++]),
                      (_ =
                        ((a[h >>> 24] << 24) | (a[(d >>> 16) & 255] << 16) | (a[(l >>> 8) & 255] << 8) | a[255 & u]) ^
                        i[p++]),
                      (e[t] = f),
                      (e[t + 1] = g),
                      (e[t + 2] = m),
  ...
  class $ {
    constructor(e = {}) {
      ;((this.encryptedConfigText = ''),
        ...
        (this.secondGcmKeyBase64 = 'en1BNo0VBrN/zi+mI2LO7E9W40ehCBYwC+frBn8s3rQ'))
    }
    setEncryptedConfig(e) {
      this.encryptedConfigText !== e && ((this.encryptedConfigText = e), (this.cachedConfigPromise = null))
    }
    normalizeBase64(e) {
      let t = String(e || '')
        .trim()
    ...
    mapDecryptedPayload(e) {
      ...
      return {
        batchUrls: this.ensureStringArray(null !== (t = r.batchUrls) && void 0 !== t ? t : r.domainList),
        eventCodes: this.ensureStringArray(null !== (i = r.eventCodes) && void 0 !== i ? i : r.eventList)
      }
    }
    prewarm() {
    ...
    async decryptAes256Gcm(e, t) {
      ...
      if ('undefined' != typeof crypto && crypto.subtle) {
        ...
        const n = i(t),
          o = r.slice(0, 12),
          s = r.slice(12),
          a = await crypto.subtle.importKey('raw', n, { name: 'AES-GCM' }, !1, ['decrypt']),
      ...
      return (
        this.cachedConfigPromise ||
          (this.cachedConfigPromise = (async () => {
            ...
            try {
              try {
                const i = await this.decryptAes256Gcm(this.encryptedConfigText, this.secondGcmKeyBase64),
              ...
              const i = this.decryptAes128Ecb(this.encryptedConfigText, this.firstEcbKey),
              ...
              return (
                'undefined' != typeof console && console.warn && console.warn('[sdk][config] decrypt failed:', e),
                i
              )
            }
          })()),
  ...
  class W {
    static canUseDocumentCookie() {
      return 'undefined' != typeof document && 'string' == typeof document.cookie
    }
    static getSidCookie() {
    ...
    static setSidCookie(e) {
      if (this.canUseDocumentCookie())
        try {
          ...
          ;('undefined' != typeof location && 'https:' === location.protocol && (i += ';Secure'),
    ...
    static parseSidStatePayload(e) {
      try {
        ...
        return i
          ? 'number' == typeof t.lastBehaviorAt && Number.isFinite(t.lastBehaviorAt)
    ...
    static randomBytes(e) {
      ...
      if ('undefined' != typeof crypto && crypto.getRandomValues) return (crypto.getRandomValues(t), t)
    ...
    static md5Hex(e = '') {
      ...
      for (let e = 0; t.length > e; e += 1) {
        ...
        if (128 > r) i.push(r)
          ...
          if (56320 > n || n > 57343) i.push(224 | (r >> 12), 128 | ((r >> 6) & 63), 128 | (63 & r))
          else {
            const t = n - 56320 + ((r - 55296) << 10) + 65536
            ;(i.push(240 | (t >> 18), 128 | ((t >> 12) & 63), 128 | ((t >> 6) & 63), 128 | (63 & t)), (e += 1))
          }
        }
      }
      const r = 8 * i.length
      ...
      const n = (e, t) => (e << t) | (e >>> (32 - t)),
        ...
        c = new Array(64)
      for (let e = 0; 64 > e; e += 1) c[e] = Math.floor(4294967296 * Math.abs(Math.sin(e + 1))) >>> 0
      let d = 1732584193,
        l = 4023233417,
        u = 2562383102,
        h = 271733878
      for (let e = 0; i.length > e; e += 64) {
        ...
        for (let r = 0; 16 > r; r += 1) {
          const n = e + 4 * r
          t[r] = (i[n] | (i[n + 1] << 8) | (i[n + 2] << 16) | (i[n + 3] << 24)) >>> 0
        }
        let r = d,
          p = l,
          y = u,
      ...
      const p = e => {
        let t = ''
        for (let i = 0; 4 > i; i += 1) t += (256 + ((e >>> (8 * i)) & 255)).toString(16).slice(1)
        return t
      }
    ...
    static hashString32(e = '') {
      let t = 2166136261
      const i = String(e || '')
      for (let e = 0; i.length > e; e += 1) ((t ^= i.charCodeAt(e)), (t = Math.imul(t, 16777619)))
      ...
      if (!this.isStorageAvailable()) {
        ...
        return r
          ? e - r.lastBehaviorAt > this.SID_TTL_MS
            ? this.issueNewSid(e)
            : ((r = { sid: r.sid, lastBehaviorAt: e }), (this.sidMemoryCache = r), this.persistSidState(r), r.sid)
          : this.issueNewSid(e)
      }
      ...
      return (
        ...
        i
          ? e - i.lastBehaviorAt > this.SID_TTL_MS
            ? this.issueNewSid(e)
            : ((i = { sid: i.sid, lastBehaviorAt: e }), (this.sidMemoryCache = i), this.persistSidState(i), i.sid)
          : this.issueNewSid(e)
      )
    }
      ...
      try {
        const e = e => {
            if (e && this.isStorageAvailable())
              try {
                window.localStorage.setItem(this.DEVICE_FINGERPRINT_STORAGE_KEY, e)
              } catch (e) {}
          },
          t = (() =>
            (this.isStorageAvailable() && window.localStorage.getItem(this.DEVICE_FINGERPRINT_STORAGE_KEY)) || '')()
        if (t) return t
        const i = 'undefined' != typeof navigator ? navigator : {},
          r = 'undefined' != typeof screen ? screen : {},
          n =
            ('undefined' != typeof Intl && Intl.DateTimeFormat && Intl.DateTimeFormat().resolvedOptions().timeZone) ||
            '',
          o = i.language || '',
          s = Array.isArray(i.languages) ? i.languages.join(',') : '',
          a = r.colorDepth || '',
          c = r.pixelDepth || '',
          d = void 0 !== r.width && void 0 !== r.height ? `${r.width}x${r.height}` : '',
          l = void 0 !== r.availWidth && void 0 !== r.availHeight ? `${r.availWidth}x${r.availHeight}` : '',
          u = 'undefined' != typeof window && window.devicePixelRatio ? window.devicePixelRatio : '',
    ...
    static getDeviceType() {
      ...
      return /Android/i.test(e) ? 'Android' : /iPhone|iPad|iPod/i.test(e) ? 'iOS' : 'PC'
    }
    static getUserAgent() {
        ...
        /iPhone/i.test(e)
          ...
          : /iPad/i.test(e)
            ...
            : /iPod/i.test(e)
              ? ((i = 'Apple'), (r = 'iPod'))
              : /Android/i.test(e)
                ? ((r = this.getAndroidModel(e)), (i = this.normalizeBrandByModel(r) || this.detectBrandFromUa(e)))
                : /Macintosh|Mac OS X/i.test(e) || /Mac/i.test(t)
                  ? ((i = 'Apple'), (r = 'Mac'))
                  : /Windows/i.test(e) || /Win/i.test(t)
                    ? ((i = 'Microsoft'), (r = 'Windows PC'))
                    : (/Linux/i.test(e) || /Linux/i.test(t)) && ((i = 'Linux'), (r = 'Linux PC')),
        (this.cachedDeviceBrandModel = {
      ...
      return t
        ? t.startsWith('SM-')
          ...
          : t.startsWith('MIX') || t.startsWith('MI ') || t.startsWith('REDMI')
            ? 'Xiaomi'
            : t.startsWith('VOG-') || t.startsWith('ANA-') || t.startsWith('ELS-')
              ? 'Huawei'
              : t.startsWith('CPH')
                ? 'OPPO'
                : t.startsWith('V20') || t.startsWith('V21') || t.startsWith('V22')
                  ? 'vivo'
                  : t.startsWith('LE2') || t.startsWith('NE2') || t.startsWith('KB2')
                    ? 'OnePlus'
                    : t.startsWith('RMX')
                      ? 'realme'
  ...
  class V {
    ...
    static async buildCommonFields(e = {}) {
      ...
      if (!['Android', 'iOS', 'PC'].includes(c)) throw new Error(`device 非法: ${c}`)
    ...
    static normalizeDevice(e) {
      ...
      return 'android' === i ? 'Android' : 'ios' === i ? 'iOS' : 'pc' === i ? 'PC' : t
    }
    static normalizeEventName(e) {
      const t = this.trimToString(e)
      if (!t || t.length > 64 || !/^[a-z0-9_]+$/.test(t)) throw new Error(`event 非法: ${t}`)
      return t
    }
    static normalizeEventId(e) {
      const t = this.trimToString(e)
      if (!t) return ''
      if (!/^[A-Za-z0-9]{1,32}$/.test(t)) throw new Error(`event_id 非法: ${t}`)
      return t
    }
    static normalizeClientTs(e) {
      const t = Number(e),
        i = Number.isFinite(t) ? Math.floor(t) : Number.NaN
      if (!Number.isFinite(i) || 946684800 > i || i > 4124444800) throw new Error(`client_ts 非法: ${e}`)
      return i
    }
    ...
    static normalizePayload(e = {}) {
      if (Object.prototype.hasOwnProperty.call(e, 'payload')) {
        const t = e.payload
        if (!t || 'object' != typeof t || Array.isArray(t)) throw new Error('payload 必须是 JSON object')
      }
      const t = {
    ...
    static async buildEventRecord(e, t = {}) {
      ...
      const a = {
        ...
        client_ts: e.client_ts ? this.normalizeClientTs(e.client_ts) : W.getClientTs(),
        ...
        device_fingerprint: this.trimToString(e.device_fingerprint || W.getDeviceFingerprint()),
                  ...
                  switch (e.event) {
                    case 'navigation':
                      return W.md5Hex(
                        K({
                          event: 'navigation',
                          navigation_key: G(null === (t = e.payload) || void 0 === t ? void 0 : t.navigation_key)
                        })
                      )
                    case 'app_page_view':
                      return W.md5Hex(
                        K({
                          event: 'app_page_view',
                          current_page_key: G(null === (i = e.payload) || void 0 === i ? void 0 : i.current_page_key)
                        })
                      )
                    case 'page_click': {
                      const t = e.payload
                    ...
                    case 'recommend_list_view':
                      return W.md5Hex(
                        K({
                          ...
                          page_key: G(null === (r = e.payload) || void 0 === r ? void 0 : r.page_key),
                          recommend_content_type: G(
                            null === (n = e.payload) || void 0 === n ? void 0 : n.recommend_content_type
                          )
                        })
                      )
                    case 'recommend_list_click':
                      return W.md5Hex(
                        K({
                          ...
                          page_key: G(null === (o = e.payload) || void 0 === o ? void 0 : o.page_key),
                          recommend_content_type: G(
                            null === (s = e.payload) || void 0 === s ? void 0 : s.recommend_content_type
                          )
                        })
                      )
                    case 'advertising': {
                      ...
                      return W.md5Hex(
                        K({
                          ...
                          advertising_key: G(null == t ? void 0 : t.advertising_key),
                          advertising_name: G(null == t ? void 0 : t.advertising_name),
                          advertising_id: G(null == t ? void 0 : t.advertising_id)
                        })
                      )
                    }
                    case 'video_event': {
                      ...
                      return W.md5Hex(
                        K({
                          ...
                          video_type_id: G(null == t ? void 0 : t.video_type_id),
                          video_behavior_key: G(null == t ? void 0 : t.video_behavior_key),
                          video_behavior_name: G(null == t ? void 0 : t.video_behavior_name)
                        })
                      )
                    }
                    case 'novel_event': {
                      ...
                      return W.md5Hex(
                        K({
                          ...
                          novel_type_id: G(null == t ? void 0 : t.novel_type_id)
                        })
                      )
                    }
                    case 'comic_event': {
                      ...
                      return W.md5Hex(
                        K({
                          ...
                          comic_type_id: G(null == t ? void 0 : t.comic_type_id)
                        })
                      )
                    }
                    case 'ad_impression': {
                    ...
                    case 'keyword_click': {
                      ...
                      return W.md5Hex(
                        K({
                          event: 'keyword_click',
                          click_item_id: G(null == t ? void 0 : t.click_item_id),
                          click_item_type_key: G(null == t ? void 0 : t.click_item_type_key),
                    ...
                    case 'keyword_search':
                      return W.md5Hex(
                        K({
                          ...
                          keyword: G(null === (a = e.payload) || void 0 === a ? void 0 : a.keyword)
                        })
                      )
                    default:
                      return
  ...
  class X {
    constructor(e = {}) {
      this.maxSize =
        Number.isFinite(Number(e.maxPersistentQueueSize)) && Number(e.maxPersistentQueueSize) > 0
          ? Math.floor(Number(e.maxPersistentQueueSize))
          : 2e3
    }
    isAvailable() {
      return 'undefined' != typeof indexedDB && 'undefined' != typeof window && void 0 !== window.indexedDB
    }
    openDb() {
    ...
    txDone(e) {
      return new Promise((t, i) => {
        ;((e.oncomplete = () => t()),
          (e.onerror = () => i(e.error || new Error('indexedDB transaction failed'))),
          (e.onabort = () => i(e.error || new Error('indexedDB transaction aborted'))))
      })
    }
    async trimOverflow(e) {
      const t = e.transaction(Q, 'readonly'),
        ...
        r = await new Promise((e, t) => {
          ;((i.onsuccess = () => e(Number(i.result || 0))), (i.onerror = () => t(i.error || new Error('count failed'))))
        })
      ...
      if (t)
        try {
          const i = t.transaction(Q, 'readwrite'),
            ...
            n = Date.now()
          ;(e.forEach((e, t) => {
            const i = e && 'object' == typeof e && Object.prototype.hasOwnProperty.call(e, 'record') ? e : { record: e }
            r.add({
              createdAt: n + t,
              record: i.record,
              endpointOverride: i.endpointOverride || '',
              retryCount: Number.isFinite(Number(i.retryCount)) ? Math.max(0, Math.floor(Number(i.retryCount))) : 0,
              nextRetryAt: Number.isFinite(Number(i.nextRetryAt)) ? Math.max(0, Math.floor(Number(i.nextRetryAt))) : 0
            })
          }),
            await this.txDone(i),
    ...
    async readOldest(e = 20) {
      ...
      if (!t) return []
      try {
        const i = t.transaction(Q, 'readonly').objectStore(Q).index('createdAt'),
          r = [],
          n = Date.now()
        return (
          await new Promise((t, o) => {
            ...
            ;((s.onerror = () => o(s.error || new Error('read cursor failed'))),
              (s.onsuccess = () => {
                ...
                const o = i.value,
                  a = Number.isFinite(Number(o.nextRetryAt)) ? Math.floor(Number(o.nextRetryAt)) : 0
                ;(a > n ||
                  r.push({
                    ...o,
                    endpointOverride: o.endpointOverride || '',
                    retryCount: Number.isFinite(Number(o.retryCount)) ? Math.floor(Number(o.retryCount)) : 0,
                    nextRetryAt: a
                  }),
                  i.continue())
              }))
    ...
    async updateRetryMeta(e = [], t, i) {
      ...
      try {
        const n = r.transaction(Q, 'readwrite'),
          o = n.objectStore(Q),
          s = Date.now(),
          a = Number.isFinite(Number(i)) ? Math.max(0, Math.floor(Number(i))) : 0,
          c = Number.isFinite(Number(t)) ? Math.max(0, Math.floor(Number(t))) : 0
        let d = 0,
          l = 0
        return (
          e.forEach(e => {
            const t = (Number.isFinite(Number(e.retryCount)) ? Math.max(0, Math.floor(Number(e.retryCount))) : 0) + 1
  ...
  class J {
    ...
    isEndpointAllowed(e, t) {
      ...
      try {
        const t = new URL(e)
        return 'https:' === t.protocol || !('http:' !== t.protocol || !this.isLocalhost(t.hostname))
      } catch (e) {
        return !1
      }
    }
    async sendBatch(e, t = [], i = {}) {
      ...
      if (!Array.isArray(t) || 0 === t.length) return { sent: !0, ok: !0, status: 200, reason: 'empty_batch' }
      ...
      if (!this.isEndpointAllowed(e, o)) return { sent: !1, ok: !1, status: 0, reason: 'insecure_endpoint' }
      if (
        n &&
        ...
        try {
          ...
          if (navigator.sendBeacon(e, t)) return { sent: !0, ok: !0, status: 200, transport: 'beacon' }
        } catch (e) {}
      if ('function' == typeof fetch)
        try {
          const t = 'undefined' != typeof AbortController ? new AbortController() : null,
            i =
              t && s > 0
                ? setTimeout(() => {
                    t.abort()
      ...
      return new Promise(t => {
        try {
          if ('undefined' == typeof XMLHttpRequest) return t({ sent: !1, ok: !1, status: 0, reason: 'no_xhr' })
          ...
          ;(i.open('POST', e, !0),
            ...
            (i.onerror = () => t({ sent: !1, ok: !1, status: 0, reason: 'xhr_error' })),
            (i.ontimeout = () =>
              t({
                sent: !1,
                ok: !1,
  ...
  class Y {
    constructor(e, t) {
      ;((this.endpointResolver = t),
        ...
        (this.batchIntervalMs =
          Number.isFinite(Number(e.batchIntervalMs)) && Number(e.batchIntervalMs) > 0
            ? Math.floor(Number(e.batchIntervalMs))
            : 5e3),
        (this.replayBatchSize =
          Number.isFinite(Number(e.replayBatchSize)) && Number(e.replayBatchSize) > 0
            ? Math.floor(Number(e.replayBatchSize))
            : 20),
        (this.replayIntervalMs =
          Number.isFinite(Number(e.replayIntervalMs)) && Number(e.replayIntervalMs) > 0
            ? Math.floor(Number(e.replayIntervalMs))
            : 5e3),
        (this.useBeacon = !0 === e.useBeacon),
        (this.trackTimeoutMs =
          Number.isFinite(Number(e.trackTimeoutMs)) && Number(e.trackTimeoutMs) > 0
            ? Math.floor(Number(e.trackTimeoutMs))
            : 3e4),
        (this.replayMaxRetries =
          Number.isFinite(Number(e.replayMaxRetries)) && Number(e.replayMaxRetries) >= 0
            ? Math.floor(Number(e.replayMaxRetries))
            : 5),
        (this.replayBackoffMaxMs =
          Number.isFinite(Number(e.replayBackoffMaxMs)) && Number(e.replayBackoffMaxMs) > 0
    ...
    settleItem(e, t) {
      e.settled ||
        ((e.settled = !0), e.timeoutTimer && (clearTimeout(e.timeoutTimer), (e.timeoutTimer = null)), e.resolve(t))
    }
    ...
    getRetryDelayMs(e) {
      const t = Number.isFinite(Number(e)) ? Math.max(0, Math.floor(Number(e))) : 0,
        i = Math.min(10, t),
        r = this.replayIntervalMs * Math.pow(2, i)
      return Math.min(this.replayBackoffMaxMs, Math.max(this.replayIntervalMs, Math.floor(r)))
    }
    dedupeRecordsForBatchSend(e) {
      ...
      for (let n = 0; e.length > n; n += 1) {
        const o = e[n],
          s =
            String(null !== (t = null == o ? void 0 : o.event_id) && void 0 !== t ? t : '').trim() ||
            `__empty_event_id__:${n}`
    ...
    async flush() {
      if ((this.purgeSettledFromQueue(), !this.flushing && 0 !== this.queue.length)) {
        ;((this.flushing = !0), this.stopTimer())
        try {
          const e = this.queue.splice(0, this.queue.length)
          if (e.length && this.endpointResolver.consumeProbeFailurePersistSignal())
            return (
              await this.persistentQueue.enqueueMany(this.toPersistentEntries(e)),
              (this.hasPersistentItems = !0),
              void e.forEach(e =>
                this.settleItem(e, {
                  sent: !1,
          ...
          for (let e = 0; r.length > e; e += 1) {
            ...
            if (!a) {
              'unavailable' === this.endpointResolver.getEndpointState()
                ? (await this.persistentQueue.enqueueMany(this.toPersistentEntries(o)),
                  (this.hasPersistentItems = !0),
                  o.forEach(e =>
                    this.settleItem(e, {
                      sent: !1,
            ...
            ;((d && d.ok) ||
              (await this.persistentQueue.enqueueMany(this.toPersistentEntries(o)), (this.hasPersistentItems = !0)),
          ...
          if (i.length) {
            ...
            ;(t.length &&
              (await this.persistentQueue.enqueueMany(this.toPersistentEntries(t)),
              (this.hasPersistentItems = !0),
              t.forEach(e =>
                this.settleItem(e, {
                  sent: !1,
    ...
    async replayPersistent() {
      if (this.hasPersistentItems && !this.replaying) {
        ...
        try {
          ...
          if (!e.length) return void (0 === (await this.persistentQueue.count()) && (this.hasPersistentItems = !1))
          const t = {}
          e.forEach(e => {
          ...
          for (let e = 0; i.length > e; e += 1) {
            ...
            const l = n.reduce((e, t) => {
                const i = Number.isFinite(Number(t.retryCount)) ? Math.floor(Number(t.retryCount)) : 0
                return Math.max(e, i)
              }, 0),
              u = this.getRetryDelayMs(l),
              h = await this.persistentQueue.updateRetryMeta(n, u, this.replayMaxRetries)
            h.dropped > 0 &&
              'undefined' != typeof console &&
              console.warn &&
              console.warn(`[sdk][replay] dropped ${h.dropped} events after max retries (${this.replayMaxRetries}).`)
          }
        } catch (e) {
        } finally {
          this.replaying = !1
    ...
    async track(e, t) {
      ...
      return new Promise((e, r) => {
        ...
        ;((o.timeoutTimer = setTimeout(() => {
          ...
          this.queue.push(o),
          this.batchMaxSize > this.queue.length ? this.schedule() : this.flush().catch(r))
      })
    }
    stop() {
      ;(this.stopTimer(), this.replayTimer && (clearInterval(this.replayTimer), (this.replayTimer = null)))
    }
    getConfig() {
      return {
  ...
  class ee {
    constructor(e) {
      ...
      ;((this.options = { ...e, channel: t }),
        ...
        (this.batcher._resolveEndpoint = e =>
          this.domainResolver.resolveEndpoint(() => this.configManager.getBatchEndpoints(), e)),
    ...
    init(e = {}) {
      ;((this.options = { ...this.options, ...e }),
        ...
        this.configManager.setEncryptedConfig(this.options.encryptedConfig || this.options.configCipher || ''),
        this.configManager.prewarm(),
        this.domainResolver.init(() => this.configManager.getBatchEndpoints()),
        this.refreshTimer && clearInterval(this.refreshTimer))
      const t =
        Number.isFinite(Number(this.options.remoteConfigRefreshMs)) && Number(this.options.remoteConfigRefreshMs) > 0
    ...
    async refreshConfig() {
      try {
        ;(this.configManager.forceRefresh(),
          await this.domainResolver.refreshDomainConfig(() => this.configManager.getBatchEndpoints()))
      } catch (e) {}
    }
    async track(e, t) {
    ...
    setContext(e = {}) {
      ...
      return (
        Object.prototype.hasOwnProperty.call(t, 'uid') && (this.options.uid = null == t.uid ? '' : String(t.uid)),
    ...
    stop() {
      ;(this.unsubEndpointReady && (this.unsubEndpointReady(), (this.unsubEndpointReady = null)),
        'undefined' != typeof window &&
          (this._onPageHide && (window.removeEventListener('pagehide', this._onPageHide), (this._onPageHide = null)),
          this._onVisibilityChange &&
      ...
      return (
        Object.keys(i).forEach(e => {
          ...
          if (!s.required || (null != a && '' !== a)) {
            if (null != a) {
              if (!this.isValidByType(a, s.type)) return void o.push(`${e}(expected ${s.type})`)
              r[e] = a
            }
          } else n.push(e)
        }),
        n.length > 0 &&
          ...
          console.error(`[sdk][event] ${e} 参数缺失：${n.join(', ')} 为必传字段。`),
        o.length > 0 &&
          'undefined' != typeof console &&
          'function' == typeof console.error &&
  ...
  const oe = e => {
      if (!ne) {
        if (void 0 === e) throw new Error('请先调用 init() 初始化（参数须包含 channel，可为空字符串 ""）')
        ne = new ee(e)
      }
      return ne
    },
              ...
              : 'string' == typeof t
                ? ((n = t),
                  (e = {}, t) => (
                    'undefined' != typeof console &&
                      'function' == typeof console.error &&
                      console.error(`[sdk][event] 调用失败：WebSDK.track.${n} 不存在。`),
                    Promise.resolve({
                      sent: !1,
                      ok: !1,
                      status: 0,
    ...
    class {
      static registerEventMethods(e) {
        ...
        Object.keys(t).forEach(i => {
          const r = t[i]
          'function' == typeof r &&
            (e.track || (e.track = () => {}), (e.track[i] = (t = {}, i) => e.track(r(t), i)), (e[i] = r))
        })
      }
