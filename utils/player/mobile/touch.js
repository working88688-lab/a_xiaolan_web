...
class Touche {
  constructor(dom, playerRoot, config = { eventType: 'touch' }) {
    this._pos = {
      moving: false,
      start: false,
      x: 0,
    ...
    this.root = dom
    this.playerRoot = playerRoot || dom
  ...
  _initEvent() {
    this.playerRoot.addEventListener(this.events.start, this.onTouchStart)
  }
  ...
  onTouchStart = e => {
    const { _pos, root, playerRoot } = this
    ...
    playerRoot.addEventListener(this.events.end, this.onTouchEnd)
  ...
  onTouchEnd = e => {
    ...
    playerRoot.removeEventListener(this.events.end, this.onTouchEnd)
  ...
  destroy() {
    ...
    this.playerRoot.removeEventListener('touchend', this.onTouchEnd)
  }
}
